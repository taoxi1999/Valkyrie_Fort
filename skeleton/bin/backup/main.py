...
class Accessories(equipment):
    def __init__(obj, posX, posY, name, endurance, rank, bodyPart, str, dex, con, mag, spr, luk):
        super(armor, obj).__init__(posX, posY, name, endurance, rank, bodyPart)
        obj.str = str
        obj.dex = dex
        obj.con = con
...
Hina = valkyrie(5,5,"valkyrie","Hina",5,5,5,5,5,5,100,50,45,0,0)
armor1 = armor(5,5,'Strall', 100, 5, 'Head', 0, 100, 5)
#Excalibur = weapon(5,5, 'Excalibur', 100, 5, 'TwoHanded', 100, 0, 50)
print "Complete!"
